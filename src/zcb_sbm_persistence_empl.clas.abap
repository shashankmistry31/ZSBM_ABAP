class ZCB_SBM_PERSISTENCE_EMPL definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      !I_EMPNO type INT4
    returning
      value(RESULT) type ref to ZCL_SBM_PERSISTENCE_EMPL
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_SBM_PERSISTENCE_EMPL .
  types:
...
CLASS ZCB_SBM_PERSISTENCE_EMPL IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_EMPNO TYPE INT4
*      RETURNING RESULT TYPE REF TO ZCL_SBM_PERSISTENCE_EMPL
************************************************************************
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_EMPNO = BUSINESS_KEY-EMPNO
...
*<Generated from mapping:
  E_BUSINESS_KEY-EMPNO  = I_DB_DATA-EMPNO.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_SBM_PERSISTENCE_EMPL,
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_SBM_PERSISTENCE_EMPL.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZSBM_EMPL.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZSBM_EMPL> type ZSBM_EMPL.
*>

*< Generated from mapping:
  select * from ZSBM_EMPL
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where ZSBM_EMPL~EMPNO = I_BUSINESS_KEY_TAB-EMPNO.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZSBM_EMPL'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZSBM_EMPL>.

*< Generated from mapping:
    DB_DATA-EMPNO = <FS_DB_ZSBM_EMPL>-EMPNO.
    DB_DATA-EMPNAME = <FS_DB_ZSBM_EMPL>-EMPNAME.
    DB_DATA-EMP_DESIGANTION = <FS_DB_ZSBM_EMPL>-EMP_DESIGANTION.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-EMPNO = BUSINESS_KEY-EMPNO.
*>
...
* * ZSBM_EMPL: internal tables for mass operation
  data DB_ITB_ZSBM_EMPL type STANDARD TABLE OF ZSBM_EMPL.
  data DB_UTB_ZSBM_EMPL type STANDARD TABLE OF ZSBM_EMPL.
  data DB_DTB_ZSBM_EMPL type STANDARD TABLE OF ZSBM_EMPL.

* * ZSBM_EMPL: headlines for tables
  data DB_ILN_ZSBM_EMPL type ZSBM_EMPL.
  data DB_ULN_ZSBM_EMPL type ZSBM_EMPL.
  data DB_DLN_ZSBM_EMPL type ZSBM_EMPL.
...
*< Generated from mapping:
   ...
   DB_ILN_ZSBM_EMPL-EMPNAME = <FS_INSERT>-EMPNAME.
   DB_ILN_ZSBM_EMPL-EMP_DESIGANTION = <FS_INSERT>-EMP_DESIGANTION.


   DB_ILN_ZSBM_EMPL-EMPNO = <FS_INSERT>-EMPNO.
   append DB_ILN_ZSBM_EMPL to DB_ITB_ZSBM_EMPL.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZSBM_EMPL-EMPNAME = <FS_UPDATE>-EMPNAME.
   DB_ULN_ZSBM_EMPL-EMP_DESIGANTION = <FS_UPDATE>-EMP_DESIGANTION.


   DB_ULN_ZSBM_EMPL-EMPNO = <FS_UPDATE>-EMPNO.
   append DB_ULN_ZSBM_EMPL TO DB_UTB_ZSBM_EMPL.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZSBM_EMPL-EMPNO = <FS_DELETE>-BUSINESS_KEY-EMPNO.

    append DB_DLN_ZSBM_EMPL TO DB_DTB_ZSBM_EMPL.
...
* * DB Deletes
  delete ZSBM_EMPL FROM TABLE DB_DTB_ZSBM_EMPL.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZSBM_EMPL FROM TABLE DB_ITB_ZSBM_EMPL
...
* * DB Updates
  update ZSBM_EMPL FROM TABLE DB_UTB_ZSBM_EMPL.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-EMPNO.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_SBM_PERSISTENCE_EMPL.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->EMPNO = I_BUSINESS_KEY-EMPNO.
* >
